...
(() => {
    ...
    const cpDescription = "Copies a file or directory.";
    const cpHelpText = "Usage: cp [options] <source> <destination>\n\nCopies the file or directory at [source] to [destination].";
